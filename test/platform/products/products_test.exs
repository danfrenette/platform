defmodule Platform.ProductsTest do
  ...
  describe "games" do
    ...
    @valid_attrs %{description: "some description", featured: true,
      thumbnail: "some thumbnail", title: "some title", slug: "some-slug"}
    ...
    @invalid_attrs %{description: nil, featured: nil, thumbnail: nil, 
      title: nil, slug: nil}
